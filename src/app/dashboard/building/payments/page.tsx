    ...
    <div className="bg-white rounded-xl shadow-sm">
      ...
      <div className="p-6">
        ...
        <div className="flex justify-center mb-6">
          <button onClick={handleSubmit} disabled={saving} className="bg-teal-600 text-white px-8 py-2 rounded-lg hover:bg-teal-700 transition font-medium disabled:opacity-50">
