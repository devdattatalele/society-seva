      ...
      <div className="p-6">
        <div className="flex flex-wrap gap-4 mb-4 items-end justify-center">
          ...
          <div>
            ...
            <select value={bankAccountId} onChange={(e) => setBankAccountId(e.target.value)} className="border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-teal-500 focus:border-transparent outline-none">
